...
namespace ShahPush\Firebase\DynamicLink;

use JsonSerializable;
use ShahPush\Firebase\DynamicLink\AnalyticsInfo\GooglePlayAnalytics;
use ShahPush\Firebase\DynamicLink\AnalyticsInfo\ITunesConnectAnalytics;
