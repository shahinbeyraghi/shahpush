...
namespace ShahPush\Firebase\Database;

use ShahPush\Firebase\Exception\Database\ReferenceHasNotBeenSnapshotted;
use ShahPush\Firebase\Exception\Database\TransactionFailed;
