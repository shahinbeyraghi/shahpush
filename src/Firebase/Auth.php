...
use ShahPush\Firebase\Auth\ApiClient;
use ShahPush\Firebase\Auth\CreateActionLink;
use ShahPush\Firebase\Auth\CreateActionLink\FailedToCreateActionLink;
use ShahPush\Firebase\Auth\IdTokenVerifier;
use ShahPush\Firebase\Auth\SendActionLink;
use ShahPush\Firebase\Auth\SendActionLink\FailedToSendActionLink;
use ShahPush\Firebase\Auth\SignIn\FailedToSignIn;
use ShahPush\Firebase\Auth\SignIn\Handler as SignInHandler;
use ShahPush\Firebase\Auth\SignInAnonymously;
use ShahPush\Firebase\Auth\SignInResult;
use ShahPush\Firebase\Auth\SignInWithCustomToken;
use ShahPush\Firebase\Auth\SignInWithEmailAndOobCode;
use ShahPush\Firebase\Auth\SignInWithEmailAndPassword;
use ShahPush\Firebase\Auth\SignInWithIdpCredentials;
use ShahPush\Firebase\Auth\SignInWithRefreshToken;
use ShahPush\Firebase\Auth\UserRecord;
...
use ShahPush\Firebase\Exception\Auth\RevokedIdToken;
...
use ShahPush\Firebase\Value\ClearTextPassword;
use ShahPush\Firebase\Value\Email;
use ShahPush\Firebase\Value\PhoneNumber;
use ShahPush\Firebase\Value\Provider;
